                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-images" role="tabpanel" aria-labelledby="pills-images-tab">
                                ...
                                <div class="owl-theme owl-carousel imovelCarousel">
                                    ...
                                    <div class="item">
                                        <a href="{{ asset('storage/' . $image->image) }}" data-fancybox="galeria"><img src="{{ asset('storage/' . $image->thumbnail) }}" class="img-fluid" title="{{ $imovel->nome }}" alt="{{ $imovel->nome }}"></a>
                                    </div>
                                    @endforeach
                        ...
                        <div class="informacoes-imovel">
                            ...
                            <div class="planta my-4">
                                ...
                                <div class="owl-theme owl-carousel imovelCarousel">
                                    ...
                                    <div class="item">
                                        <img class="w-75" src="{{ asset('storage/' . $planta->image) }}" class="img-fluid" alt="...">
                                    </div>
                                    @endforeach
                            ...
                            <div class="box-info-contato mt-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span>contato@conquestbroker.com.br</span>
                                    </li>
                                    <li>

                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($imoveis as $imovel)
                                    ...
                                    <tr>
                                        <td>{{ $imovel->id }}</th>
                                        <td><img class="w-50" src="{{ asset('storage/'. $imovel->imagem) }}" alt=""></td>
                                        <td>{{ $imovel->nome }}</td>
                                        <td>{{ $imovel->categoriaNome }}</td>
                                        <td>{{ $imovel->cidade }}</td>
                                        <td width="15%">
                                            <a href="{{ route('admin.imoveis.edit', ['imovel' => $imovel->id]) }}"
                                                class="btn btn-sm btn-primary">Editar</a>
                                            <a href="javascript:;" data-toggle="modal" data-id='{{ $imovel->id }}'

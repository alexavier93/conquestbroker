                ...
                <div class="card-body">
                    ...
                    <nav>
                        <div class="nav nav-pills" id="tabStep" role="tablist">
                            ...
                            <a class="nav-link" id="step6-tab" data-toggle="tab" href="#step6" role="tab" aria-controls="step6" aria-selected="false">Galeria</a>
                            <a class="nav-link" id="step7-tab" data-toggle="tab" href="#step7" role="tab" aria-controls="step7" aria-selected="false">Plantas</a>
                            <a class="nav-link" id="step8-tab" data-toggle="tab" href="#step8" role="tab" aria-controls="step8" aria-selected="false">Status Obra</a>
                        </div>
                    </nav>
